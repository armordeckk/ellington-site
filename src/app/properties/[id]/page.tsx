      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="mb-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <div className="text-left lg:text-right">
            <p className="text-[11px] tracking-[0.22em] uppercase text-muted mb-1">Prix</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mt-16">
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-[var(--border)] border border-[var(--border)]">
              {[
                ...
                { icon: "area", label: "Surface", value: `${property.area} m²` },
                {
                  icon: "calendar",
                  label: property.yearBuilt && property.yearBuilt < 1900 ? "Origine" : "Année",
            ...
            <div>
              <h2 className="font-serif text-3xl mb-6">
                <em className="italic">Description</em>
              </h2>
            ...
            {property.features.length > 0 && (
              <div>
                <h2 className="font-serif text-3xl mb-6">
                  <em className="italic">Prestations</em>
                </h2>
            ...
            <div>
              <h2 className="font-serif text-3xl mb-6">
                <em className="italic">Localisation</em>
              </h2>
              ...
              <p className="text-sm text-muted mt-4">
                Adresse précise communiquée sur demande, dans le respect de la
                confidentialité de notre client.
              </p>
            </div>
          </div>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28 self-start">
            <div className="bg-[var(--background-card)] border border-[var(--border)] p-8">
              <h3 className="font-serif text-2xl mb-2">Intéressé ?</h3>
              <p className="text-sm text-muted mb-6">
                Contactez-nous pour plus d&apos;informations ou planifier une
                visite privée.
              </p>
              <Link
            ...
            <div className="bg-[var(--background-card)] border border-[var(--border)] p-8">
              <h3 className="font-serif text-2xl mb-5">Votre conseiller</h3>
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted">Directeur du portefeuille</p>
                </div>
              </div>
            ...
            <div className="border border-accent/40 p-6">
              <h4 className="font-serif text-lg mb-2">Service confidentiel</h4>
              <p className="text-xs text-muted leading-relaxed">
                Toutes les demandes sont traitées avec la plus stricte
                discrétion. Notre clientèle internationale apprécie notre
        ...
        {similar.length > 0 && (
          <div className="mt-28 pt-20 border-t border-[var(--border)]">
            <h2 className="font-serif text-3xl md:text-4xl mb-10">
              Biens <em className="italic">similaires</em>
            </h2>
